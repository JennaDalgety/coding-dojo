...
SELECT  countries.name AS country_name, cities.name AS capital_name, countries.government_form, cities.population, countries.life_expectancy
FROM countries
JOIN cities
...
-- district and have the population greater than 500, 000? The query should return the Country Name, 
